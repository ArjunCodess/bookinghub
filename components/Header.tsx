...
const products = [
  {
    name: "Book a Stay",
    description: "Secure your ideal accommodation effortlessly.",
    href: "#",
    icon: HomeIcon,
  },
  {
    name: "Book a Flight",
    description: "Directly book flights for seamless travel.",
    href: "#",
    icon: PaperAirplaneIcon,
  },
  {
    name: "Contact our Support Team",
    description: "Ensuring safe and secure customer support.",
    href: "#",
    ...
    <header className="bg-[#006666]">
      ...
      >
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                  {callsToAction.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center justify-center gap-x-2.5 p-3 text-md font-semibold leading-6 text-[#013B94] hover:bg-gray-100"
                    >
                      <item.icon
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="https://account.booking.com/sign-in" target="_blank" className="text-md font-semibold leading-6 text-white">
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-white hover:bg-green-800">
                        Stays
                        <ChevronDownIcon
                          className={cn(
                            open ? "rotate-180" : "",
                      ...
                      <Disclosure.Panel className="mt-2 space-y-2">
                        {[...products, ...callsToAction].map((item) => (
                          <Disclosure.Button
                            ...
                            as="a"
                            href={item.href}
                            className="block rounded-lg py-2 pl-6 pr-3 text-md font-semibold leading-7 text-white hover:bg-green-800"
                          >
                            {item.name}
                          </Disclosure.Button>
                        ))}
              ...
              <div className="py-6">
                <a
                  href="https://account.booking.com/sign-in"
                  target="_blank"
